...
const LoginPage = () => {
  ...
  const login = useMutation(
    (variables: Variables) => {
      return request('http://localhost:4200/graphql', LOGIN, variables);
    },
    {
      onSuccess: (data: any) => {
        localStorage.setItem('token', data.login.token);
        console.log(data.login.user);
        queryClient.setQueryData([QUERY_KEY.user], data.login.user);
  ...
  return (
    <div className="h-screen bg-boxdark flex flex-wrap items-center">
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                value={email}
                required
                className="w-full rounded-lg border bg-transparent py-4 pl-6 pr-10 outline-none border-form-strokedark bg-form-input focus:border-primary"
              />
