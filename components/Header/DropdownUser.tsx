...
const DropdownUser = () => {
  ...
  const userSetting = async () => {
    router.push({
      pathname: "/settings",
      query: { id: user?._id, name: user?.name, email: user?.email },
    });
  };
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border shadow-default border-strokedark bg-boxdark ${dropdownOpen === true ? "block" : "hidden"
          }`}
      >
